# Business Model: Manufacture of musical instruments
...
## Classification
- Repository: `cloud-itonami-isic-3220` ([github.com/cloud-itonami/cloud-itonami-isic-3220](https://github.com/cloud-itonami/cloud-itonami-isic-3220))
- ISIC Rev.5: `3220` — Manufacture of musical instruments
- Domain: `:musical-instrument/manufacturing`
- Social impact: :worker-safety :materials-safety :consumer-protection
- Actor: `:musical-instrument-workshop-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :musical-instrument/manufacturing — who wants
...
One managed tenant (:musical-instrument/manufacturing):
...
- Do not bypass the `:musical-instrument-workshop-plant-operations-governor` for production decisions.
