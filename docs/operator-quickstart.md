# Operator Quickstart — Manufacture of musical instruments

Shortest path from clone to a verified local dry-run for **ISIC 3220** (`cloud-itonami-isic-3220`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3220.git
cd cloud-itonami-isic-3220
```
...
- Blueprint governor key: `musical-instrument-workshop-plant-operations-governor`
- Likely source path: `musicinstrmfg.governor.cljc`
