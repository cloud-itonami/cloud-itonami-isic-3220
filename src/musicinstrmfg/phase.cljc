(ns musicinstrmfg.phase
  "Phase 0->3 staged rollout for the musical-instrument-workshop
  ...
  consequence (a crafting/assembly-equipment maintenance window means
  production downtime, and the equipment ends up actually touched); it
  is always a human workshop supervisor's call.
  `musicinstrmfg.governor`'s `actuate-equipment-blocked-violations`
...
(defn verdict->disposition
  "Map a Musical Instrument Workshop Plant Operations Governor verdict
